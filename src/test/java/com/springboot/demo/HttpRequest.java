...
public class HttpRequest {
    ...
    @Test
    public void setPostDat(){
        String url = "http://localhost:8080/httpService/hello";
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("name","yzn");
        jsonObject.put("city","taiy");
        JSONArray jsonArray = new JSONArray();
        jsonArray.add(jsonObject);
        jsonObject = new JSONObject();
        jsonObject.put("name","bbb");
        jsonObject.put("city","hen");
        jsonArray.add(jsonObject);
        String json = sendPost(url,jsonArray.toJSONString());
