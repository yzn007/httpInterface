 ...
 */
public class Per10SJob implements BaseJob {
    ...
    final String topicName = Per10SJob.class.getSimpleName();
    final String configName = "project.properties";

    private static Logger _log = LoggerFactory.getLogger(Per10SJob.class);
