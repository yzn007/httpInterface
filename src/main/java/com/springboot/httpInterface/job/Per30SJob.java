 ...
 */
public class Per30SJob implements BaseJob {
    ...
    final String topicName = Per30SJob.class.getSimpleName();
    final String configName = "project.properties";

    private static Logger _log = LoggerFactory.getLogger(Per30SJob.class);
