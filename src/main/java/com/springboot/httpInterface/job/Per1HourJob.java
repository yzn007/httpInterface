 ...
 */
public class Per1HourJob implements BaseJob {
    ...
    final String topicName = Per1HourJob.class.getSimpleName();
    final String configName = "project.properties";

    private static Logger _log = LoggerFactory.getLogger(Per1HourJob.class);
